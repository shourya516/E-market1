        ...
        <div class="column">
            <nav>
                <ul class="menu" style="padding-left: 100px;">
                    <a href="/home" style="text-decoration: none;"><li>Customers</li></a>
                    <%-- <a href="/about" style="text-decoration: none;"><li>About us</li></a>--%>
                    <a href="/products" style="text-decoration: none;"><li>Dealers</li></a>
                    <a href="/cart" style="text-decoration: none;"><li>Vendors</li></a>
                </ul>
            </nav>
        </div>
        <div class="column" >
